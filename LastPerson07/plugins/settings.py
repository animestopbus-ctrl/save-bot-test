...
import string
import random
from LastPerson07.shared_client import client as gf
from LastPerson07.config import OWNER_ID
from LastPerson07.utils.func import get_user_data_key, save_user_data, users_collection
...
async def send_settings_message(chat_id, user_id):
    buttons = [
        ...
        [
            Button.url('🆘 Report Errors', 'https://t.me/DmOwner')
        ]
    ]
