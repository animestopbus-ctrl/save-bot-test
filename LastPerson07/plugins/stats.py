...
from LastPerson07.shared_client import client as bot_client
from telethon import events
from LastPerson07.utils.func import get_premium_details, is_private_chat, get_display_name, get_user_data, premium_users_collection, is_premium_user
from LastPerson07.config import OWNER_ID
import logging
logging.basicConfig(format=
    '%(asctime)s - %(name)s - %(levelname)s - %(message)s', level=logging.INFO)
logger = logging.getLogger('LastPerson07')
