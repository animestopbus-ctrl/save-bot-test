...
LOG_GROUP    = int(os.getenv("LOG_GROUP", "-1003201165504"))
FORCE_SUB    = int(os.getenv("FORCE_SUB", "-1003350234022"))
...
# ─── UI / LINKS ─────────────────────────────────────────────────────────────────
JOIN_LINK     = os.getenv("JOIN_LINK", "https://t.me/THEUPDATEDGUYS")
ADMIN_CONTACT = os.getenv("ADMIN_CONTACT", "https://t.me/DmOwner")
